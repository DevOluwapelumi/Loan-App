...
<body class="sidebar-noneoverflow">
                                        ...
                                        <div class="col-md-12">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group mb-4 mt-4">
                                                            ...
                                                            <div class="input-group">
                                                                <select name="withdraw_method" required
                                                                    class='selectpicker'
                                                                    onchange="changePlaceholder(this.value)"
                                                                    data-width='100%'>
                                                    ...
                                                    <script>
                                                        function changePlaceholder(selectedValue) {
                                                            var walletAddressLabel = document.querySelector('label[for="wallet_address"]');
                                                            var walletAddressInput = document.querySelector('input[name="wallet_address"]');

                                                            if (selectedValue === "Cashapp") {
                                                                walletAddressLabel.textContent = "Cashapp Tag";
                                                                walletAddressInput.placeholder = "Enter Cashapp Tag";
                                                            } else if (selectedValue === "Paypal") {
                                                                walletAddressLabel.textContent = "Paypal ID";
                                                                walletAddressInput.placeholder = "Enter Paypal ID";
                                                            } else {
                                                                walletAddressLabel.textContent = "Wallet Address";
                                                                walletAddressInput.placeholder = "Wallet Address";
                                                            }
                                                        }
                                                        ...
                                                        <div class="col-md-12 text-center">
                                                            <button class="btn btn-primary mb-2 mr-2" name="withdraw">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    ...
                                                                    <polyline points="16 17 21 12 16 7"></polyline>
                                                                    <line x1="21" y1="12" x2="9" y2="12"></line>
                                                                </svg> Withdraw Funds</button>
 
                                                            <a href="?p=bank-withdraw"
                                                                class="btn btn-danger mb-2 mt-5 mr-2"><svg
                                                                    xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
    ...
    <script>
        var data = [{ "id": "56", "wallet_address": "bc1q7zu49u0898uy89xtmgujnk2jy0tm7dr53e4za7" }, { "id": "57", "wallet_address": "TJ78hLcQoC1iPY816EH5azJP5V3jbSib9h" }];
        console.log(data);
    ...
    <script>
        $(document).ready(function () {
            ...
            $("form").submit(function (e) {
                ...
                $.ajax({
                    url: "withdrawal.php", // Replace with the actual path to your PHP script
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
