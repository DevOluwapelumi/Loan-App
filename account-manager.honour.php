                                            ...
                                            <div class="row">
                                                <div class="col-xl-2 col-lg-12 col-md-4 text-center">
                                                    <div class="upload mt-4 pr-md-4">
                                                       <center>
                                                           <input type="file" class="dropify" data-default-file="/assets/profile/" name="mgr_image" data-max-file-size="2M" / disabled>
                                                           
                                                           <!--<img src="/assets/profile/" class="dropify">-->
                                                       </center>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <!--<input type="text" class="form-control mb-4" id="mgr_no" placeholder="" value="" readonly>-->
                                                                </div>
                                                            </div>
                                                        </div>
