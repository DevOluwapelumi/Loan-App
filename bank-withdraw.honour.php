                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="postcode"
                                                        name="postcode" placeholder="Enter your postcode">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="routingNumber"
                                                        name="routingNumber" placeholder="Enter routing number">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="accountNumber">Sort Code</label>
                                                    <input type="text" class="form-control" id="sortcode"
                                                        name="sortcode" placeholder="Enter Sort Code">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 text-center">
                                                        ...
                                                        <a href="?p=withdrawal" class="btn btn-danger mb-2 mr-2"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
