...
$totalTransactionSql = "SELECT IFNULL(SUM(Amount), 0) AS TotalAmount FROM Transfers WHERE UserID = $id";
...
// Calculate the total transactions
$totalLoanSql = "SELECT IFNULL(SUM(Amount), 0) AS loan FROM loan WHERE user_id = $id AND status = 1";
$totalLoanResult = $conn->query($totalLoanSql);

if ($totalLoanResult->num_rows > 0) {
    $totalLoan = $totalLoanResult->fetch_assoc();

    // Display the total Loan amount
    $loan = number_format($totalLoan["loan"], 2);
} else {
    $loan = number_format(0, 2);
}

// Calculate the total transactions
$totalpendingLoanSql = "SELECT IFNULL(SUM(Amount), 0) AS pendingloan FROM loan WHERE user_id = $id AND status = 0";
$totalpendingLoanResult = $conn->query($totalpendingLoanSql);

if ($totalpendingLoanResult->num_rows > 0) {
    $totalpendingLoan = $totalpendingLoanResult->fetch_assoc();

    // Display the total pendingLoan amount
    $pendingloan = number_format($totalpendingLoan["pendingloan"], 2);
} else {
    $pendingloan = number_format(0, 2);
}
...
<div id="content" class="main-content">
    <div class="layout-px-spacing-dashboard">
        ...
        <div class="row layout-top-spacing">
            ...
            <h6 class="text-white">Kindly complete your KYC process to qualify for our loan offers.</h6>
            <a href="?p=kyc" class="btn btn-primary">Complete KYC</a>
            </div>
            <?php }?>
...
<div class="widget widget-account-invoice-three">
    ...
    <div class="widget-heading">
        <div class="wallet-usr-info">
            ...
            <div >
                <span><a href="?p=loan"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus text-white"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></a></span>
            </div>
        </div>
        <div class="wallet-balance">
            <p>Balance</p>
            <h5 class=""><span class="w-currency"><?php echo $acct_currency;?></span><?php echo $balance?></h5>
        </div>
    ...
    <div class="widget-amount">
        ...
        <div class="w-a-info funds-received">
            <span>Pending Loan<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></span>
            ...
            <p>
                ...
                <?php echo $acct_currency;?><?php echo $pendingloan;?>                              
            </p>
        </div>

        <div class="w-a-info funds-spent">
            <span>Active Loan <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-up"><polyline points="18 15 12 9 6 15"></polyline></svg></span>
            <p class="text-danger"><?php echo $acct_currency;?><?php echo $loan;?>
            </p>
        </div>
    </div>
    ...
    <div class="widget-content">
        ...
        <div class="bills-stats; text-center">
            <button class="btn btn-success btn-sm">ACTIVE</button>                        </div>
        ...
        <div class="invoice-list">
            ...
            <div class="inv-detail">
                <div class="info-detail-1">
                    <p>Account Limit</p>
                    <p><span class="w-currency"><?php echo $acct_currency;?></span><span class="bill-amount"><?php echo $account_limit;?></span></p>
                </div>
                ...
                <div class="info-detail-3">
                    <p>Recent Transaction</p>
                     ...
                     <p><span> <?php echo $acct_currency;?><?php echo $lastTransaction?></span></p>
                </div>
         ...
         <div class="info-detail-2">
                    <p>Last Login IP:</p>
                    <p class=""><span class="bill-amount text-danger"><?php echo $last_login_ip;?> </span></p>
                </div>
                
                <div class="info-detail-2">
                    <p>Last Login Date:</p>
                    <p class=""><span class="bill-amount text-danger"><?php echo $last_login_time;?></span></p>
                </div>
            ...
            <div class="inv-action">
                <a href="?p=deposit"class="btn btn-primary ">Make a Deposit</a>
                <a href="?p=loan"class="btn btn-primary ">Take a Loan</a>
            </div>
        </div>
    </div>
                        ...
                        <div class="order-summary">
                            ...
                            <div class="summary-list">
                                ...
                                <div class="w-summary-details">
                                    ...
                                    <div class="w-summary-info">
                                        <h6>Limit</h6>
                                        <p class="summary-count"><?php echo $acct_currency;?><?php echo $account_limit?></p>
                                    </div>
                            ...
                            <div class="summary-list">
                                ...
                                <div class="w-summary-details">
                                    ...
                                    <div class="w-summary-info">
                                        <h6>Loan Balance</h6>
                                        <p class="summary-count"><?php echo $acct_currency;?><?php echo $loan;?></p>
                                    </div>
                            ...
                            <div class="summary-list">
                                ...
                                <div class="w-summary-details">
                                    ...
                                    <div class="w-summary-info">
                                        <h6>Expenses</h6>
                                        <p class="summary-count"><?php echo $acct_currency;?><?php echo $totalAmount?></p>
                                    </div>
                ...
                <div class="widget-two">
                    <div class="widget-content">
                        <div class="w-numeric-value">
                            <div class="w-content">
                                ...
                                <span class="w-numeric-title"><a class="text-primary" href="?p=credit-debit_transaction">Go to Transaction for details.</a></span>
                            </div>
                            <div class="w-icon">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Recent Loan Transactions</h5>
                        </div>
  ...
  $sql = "SELECT * FROM loan WHERE user_id = (SELECT id FROM user_registration WHERE username = ?) ORDER BY loan_id DESC";
  ...
  if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
        if ($row['status'] == 1) {
          ...
          echo "<td>" . (strlen($row['loan_remarks']) > 20 ? substr($row['loan_remarks'], 0, 20) . "..." : ($row['loan_remarks'] ? $row['loan_remarks'] : '-')) . "</td>";
          echo "<td>" . $status . "</td>";
          echo "<td><a class='btn btn-primary repay-btn' href='?p=loan-transaction' data-loan-id='" . $row['loan_id'] . "'>Repay Loan</a></td>";
...
<script>
        // Use fetched data to create a bar chart
        var options = {
            chart: {
                type: 'bar'
            },
            series: [{
                name: 'Daily Stats',
                data: <?php echo json_encode(array_values($dayOfWeekCounts)); ?>
            }],
            xaxis: {
            ...
            yaxis: {
                labels: {
                    formatter: function (val, index) {
                        return index !== 0 && val % 1 === 0 ? parseInt(val) : '';
                    }
                }
            },
            plotOptions: {
                bar: {
                    ...
                    colors: {
                        ranges: [{
                            ...
                            from: 1,
                            to: <?php echo max($dayOfWeekCounts); ?>,
                            color: '#ff9900'
                        }]
                    }
                }
