...
// Calculate the total transactions
$totalLoanSql = "SELECT SUM(Amount) AS loan FROM loan WHERE user_id = $id AND status=1";
...
// Calculate the total transactions
$totalpendingLoanSql = "SELECT SUM(Amount) AS pendingloan FROM loan WHERE user_id = $id and status=0";
            ...
            <div class="account-content">
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-2 col-lg-12 col-md-4 text-center">
                                                    <!--<div class="upload mt-4 pr-md-4">
                                                       <center>
                                                           <input type="file" id="input-file-max-fs" class="dropify" data-default-file="assets/profile/1702072625IMG-20231208-WA0116.jpg" name="image" data-max-file-size="2M" />
                                                       </center>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" id="fullName" placeholder="Account Number" value="<?php echo $accountNumber?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="profession">Account Type</label>
                                                                    <input type="text" class="form-control mb-4" id="profession" placeholder="" value="<?php echo $acct_type?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" id="fullName" placeholder="EMail" value="<?php echo $acct_email?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="fullName">Gender</label>
                                                                    <input type="text" class="form-control mb-4 text-capitalize"  placeholder="Ocuppation" value="male" readonly>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4"  placeholder="Ocuppation" value="<?php echo $occupation?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="profession">Phone Number</label>
                                                                    <input type="text" class="form-control mb-4" id="profession" placeholder="Phone Number" value="<?php echo $phoneNumber?>" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-11 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mb-4" name="acct_address" placeholder="Designer" value="<?php echo $addressString = $address . ($suite ? ', ' . $suite : '') . ', ' . $city . ', ' . $state . ' ' . $zipcode . ', ' . $country;?>" readonly>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 layout-spacing">
                        <form class="section about" id="changepassword" method="post">
                            <div class="info">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 layout-spacing">
                            <form class="section about" id="changepin" method="post" autocomplete="off" autofocus="off">
                                <div class="info">
...
<script>
  $(document).ready(function() {
    ...
    $("#changepassword").submit(function(e) {
      ...
      $.ajax({
        url: "changepassword.php", // Replace with the actual path to your PHP script
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
          ...
          try {
            ...
            if (responseData.success) {
              ...
              Swal.fire({
                ...
                window.location.href = "?p=edit-profile";
              });
...
<script>
  $(document).ready(function() {
    ...
    $("#changepin").submit(function(e) {
      ...
      // Perform Ajax request
      $.ajax({
        url: "changepin.php", // Replace with the actual path to your PHP script
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
          ...
          try {
            ...
            if (responseData.success) {
              ...
              Swal.fire({
                ...
                // Redirect to edit-profile after clicking "OK"
                window.location.href = "?p=edit-profile";
              });
            } else if (responseData.error) {
              // Show error message using SweetAlert
