...
<head>
    ...
    <title>Funding - <?php echo $sitename?>  </title>
                ...
                <div class="card component-card">
                    <div class="card-body">
                        <div class="user-profile">
                            <div class="row">
                                <div class="col-md-12">
                                                                        <form method="POST" id="transfer_form"  enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group ">
                                                        <input type="text" class="form-control" name="swift_code" id="swift_code" placeholder="" value=""
                                                               aria-label="notification" aria-describedby="basic-addon1"
                                                               readonly>
...
<script>
  $(document).ready(function() {
    ...
    $("form").submit(function(e) {
      ...
      $.ajax({
        url: "deposit.php", // Replace with the actual path to your PHP script
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
