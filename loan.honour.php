                                        ...
                                        <div class="col-md-12">
                                            ...
                                            if ($kyc == 0) { ?>
                                                <div class="alert alert-danger col-12  ">
                                                    <h6 class="text-white">Kindly complete your KYC process to qualify for
                                                        our loan offers.</h6>
                                            ...
                                            <form method="POST">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text" id="basic-addon1">
                                                                        <?php echo $acct_currency ?>
                                                                    </span>
                                                                </div>
                                                                <input type="number" class="form-control" id="loan-amount" name="amount"
                                                                    value="" placeholder="Amount"
                                                                    aria-label="notification"
                                                                    aria-describedby="basic-addon1">
                                                            </div>
                                                            <p>Interest: <strong>16%</strong> <br> Payback amount:
                                                                <strong id="payback"></strong></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-4 mt-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h6>Key Contact Info</h6>
                                                        <p>Kindly provide 2 key contacts information to strenghten your
                                                            application. These contacts must be active and authentic</p>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group mb-4 mt-4">
                                                            <label for="relationship1">Relationship with Contact
                                                                1</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group mb-4 mt-4">
                                                            <label for="relationship2">Relationship with Contact
                                                                2</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-4 mt-4">
                                                            <label for="loan_remarks">Narration/Purpose</label>
                                                            <textarea class="form-control mb-4" rows="3"
                                                                id="loan_remarks" placeholder="Loan Description"
                                                                name="loan_remarks"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-4 mt-4">
                                                            <label for="repayment_pattern">Repayment Pattern</label>
                                                            <select class="form-control" name="repayment_pattern">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 text-center">
                                                        <button class="btn btn-primary mb-2 mr-2" name="loan-submit">
    ...
    <script>
        $(document).ready(function () {
            function calculatePayback(amount) {
                // Calculate payback amount with 16% extra interest
                var interest = 0.16 * amount;
                var paybackAmount = amount + interest;
                return paybackAmount.toFixed(2); // Round to 2 decimal places
            }

            // Bind input event handler to the loan amount input field
            $('#loan-amount').on('input', function () {
                // Get the loan amount value
                var amount = parseFloat($(this).val());

                // Check if amount is valid
                if (!isNaN(amount) && amount >= 0) {
                    // Calculate and display the payback amount
                    var paybackAmount = calculatePayback(amount);
                    $('#payback').text('<?php echo $acct_currency?>' + paybackAmount);
                } else {
                    // If the amount is not valid, display empty payback amount
                    $('#payback').text('');
                }
            });
            ...
            $("form").submit(function (e) {
                ...
                if ('<?php echo $kyc ?>' == 0) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Please complete your KYC Registration'
                    })
                    exit();
                }
                // Get form data
                ...
                $.ajax({
                    url: "loan.php", // Replace with the actual path to your PHP script
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
                        ...
                        try {
                            ...
                            if (responseData.success) {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = "?p=loan-transaction";
                                });
